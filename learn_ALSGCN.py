...
from dataloader import DataLoader  # 导入数据加载器
...
def parse_args():  # 解析命令行参数函数
    ...
    parser.add_argument('--name', type=str, default='csi100_ALSGCN')  # 名称，默认为csi100_ALSGCN
    ...
    parser.add_argument('--outdir', default='./output/csi100_ALSGCN')  # 输出目录，默认为'./output/csi100_ALSGCN'
